-- Basic information
LANG.Name		= "Dutch"	-- Native name for language
...
LANG.Request_DeleteTooltip		= "Verwijder video uit geschiedenis"
...
LANG.Settings_MuteFocusLabel	= "Demp audio wanneer gealt-tabd"
